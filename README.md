...
a. Run an open-source OCR tool to transform pdfs to txt files. Script: [pdfToTxt.sh](https://github.com/Linguistics575/pentimento/blob/master/pdfToTxt.sh)
b. Do some post-processing on the txt files to automatically correct some mistakes. Script: [ocrPostProcess.sh](https://github.com/Linguistics575/pentimento/blob/master/ocrPostProcess.sh)
...
Before running ocrPostProcess.sh, you need to unzip this file: [WikipediaTitles/titleWordCount.zip](https://github.com/Linguistics575/pentimento/blob/master/WikipediaTitles/titleWordCount.zip)
