...
a. [pdfToTxt.sh](https://github.com/Linguistics575/pentimento/blob/master/pdfToTxt.sh) Run an open-source OCR tool to transform pdfs to txt files.  
b. [ocrPostProcess.sh](https://github.com/Linguistics575/pentimento/blob/master/ocrPostProcess.sh) Do some post-processing on the txt files to automatically correct some mistakes.
